...
- (void)loadView {
    ...
    desc.text = NSLocalizedStringFromTableInBundle(@"This forum is a place to share thoughts and ideas about how to improve Koko. It’s not a place to discuss personal issues. As always, please remember that Koko is a supportive community.", @"UserVoice", [UserVoice bundle], nil);
